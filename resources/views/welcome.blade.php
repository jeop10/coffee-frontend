...
<div class="container py-3">
    <header>
        ...
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
            <h1 class="display-4 fw-normal">Best selling</h1>
            <p class="fs-5 text-muted">
                The best coffee on the internet.
            </p>
        </div>
    </header>
        ...
        <div class="row row-cols-1 row-cols-md-4 mb-3 text-center">
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        <a href="/coffee/cortado" class="card-title h2 pricing-card-title text-decoration-none">Pumpkin</a>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                    <a href="/coffee/cortado"class="card-title h2 pricing-card-title text-decoration-none">Cappuccino</a>
                        <h2 class="h4 mb-4">$12,99</h2>
                        <a href="/cart-detail" class="w-100 btn btn-lg btn-outline-primary">
                            Add to cart
                        </a>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                    <a href="/coffee/cortado" class="card-title h2 pricing-card-title text-decoration-none">Misto</a>
                        <h2 class="h4 mb-4">$12,99</h2>
                        <a href="/cart-detail" class="w-100 btn btn-lg btn-outline-primary">
                            Add to cart
                        </a>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                    <a href="/coffee/cortado" class="card-title h2 pricing-card-title text-decoration-none">Latte</a>
                        <h2 class="h4 mb-4">$12,99</h2>
                        <a href="/cart-detail" class="w-100 btn btn-lg btn-outline-primary">
                            Add to cart
                        </a>
