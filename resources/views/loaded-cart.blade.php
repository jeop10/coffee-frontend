...
<div class="container py-3">
    <header>
        ...
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
            <h1 class="display-4 fw-normal">Enjoy a Cortado</h1>
            <p class="fs-5 text-muted">
                The best cortado on the internet.
            </p>
        </div>
    </header>
    ...
    <main>
        <div class="row mb-3">
            ...
            <div class="col-12 col-md-6">
                <div class="p-2">
                    <h1 class="H2 text-center mb-3">Pupking</h1>
    ...
    <section class="pt-4 my-md-5 pt-md-5 text-center" style="border-top: 1px dashed lightgray">
        <h3 class="h4 fw-normal">There is more</h3>
        <p class="fs-5 text-muted">
            Other coffees that taste good, extra good.
        </p>
